...
- ⚡ Hybrid SPA Architecture (SEO-friendly + dynamic navigation)
- 🎨 Modern UI built with Tailwind CSS
- 🌌 3D Animated Background using Three.js
- 🎬 Advanced animations with GSAP
- 🌙 Dark Mode with local storage persistence
- 🛠 Custom Admin Panel (Not default Django Admin)
- 📊 Built-in Analytics Tracking (SiteVisit model)
- 📩 Secure Contact Form with validation & anti-spam logic
...
- Django 5
- Python
- SQLite (Switchable to PostgreSQL for production)
